...
****************************************************************************************************/
.controller('HomeRedCard_Ctrl', function($scope, $state, $http, $stateParams, Matches, HomeTeams, Teams, Players, PlayerSeasons, MatchPlayers) {
  ...
  PlayerSeasons.query().$promise.then(function(response){
    ...
    $scope.submit_home = function(id) {
      ...
      var red_card = 'http://balf.rs/api/v1/red_cards';
...
****************************************************************************************************/
.controller('AwayRedCard_Ctrl', function($scope, $state, $http, $stateParams, Matches, AwayTeams, Teams, Players, PlayerSeasons, MatchPlayers) {
  Matches.query().$promise.then(function(response){
    $scope.id_meca = localStorage.getItem('current_match');
    $scope.matches = response;
