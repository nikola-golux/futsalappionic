...
****************************************************************************************************/
.controller('HomeYellowCard_Ctrl', function($scope, $state, $http, $stateParams, Matches, HomeTeams, Teams, Players, PlayerSeasons) {
...
****************************************************************************************************/
.controller('AwayYellowCard_Ctrl', function($scope, $state, $http, $stateParams, Matches, AwayTeams, Teams, Players, PlayerSeasons) {
  Matches.query().$promise.then(function(response){
    $scope.id_meca = localStorage.getItem('current_match');
    $scope.matches = response;
    /* Funkcija za nalazenje JSON elementa */
